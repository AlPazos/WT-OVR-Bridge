 ...
 * <p>
 * WtOvr requests ?include= with: homeCompetitor, homeCompetitor.participants,
...
public class WtOvrResource {
    ...
    public Response postAction(@PathParam("id") String matchId, String body) {
        ...
        // WtOvr ignores the response body
        ObjectNode root = mapper.createObjectNode();
        ObjectNode data = mapper.createObjectNode();
    ...
    private ObjectNode buildMatchNode(MatchConfigurationDto dto, Integer mat) {
        ...
        // phase como String — WtOvr usa match.getPhase().toString()
     ...
     * Used by WtDataToWtOvrConverter.convertEvent() to build CategoryDto.
     */
