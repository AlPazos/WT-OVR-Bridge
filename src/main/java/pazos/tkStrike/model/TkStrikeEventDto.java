...
public class TkStrikeEventDto {
    ...
    public String getMatchVMInternalId() {
        return matchVMInternalId;
    }

    public void setMatchVMInternalId(String v) {
        this.matchVMInternalId = v;
    }

    public String getMatchVMRingNumber() {
        return matchVMRingNumber;
    }

    public void setMatchVMRingNumber(String v) {
        this.matchVMRingNumber = v;
    }
    ...
    public void setMatchCategoryName(String v) {
        this.matchCategoryName = v;
    }

    public String getMatchCategoryGender() {
        return matchCategoryGender;
    }

    public void setMatchCategoryGender(String v) {
        this.matchCategoryGender = v;
    }

    public String getMatchSubCategoryName() {
        return matchSubCategoryName;
    }

    public void setMatchSubCategoryName(String v) {
        this.matchSubCategoryName = v;
    }
    ...
    public void setRoundNumber(Integer v) {
        this.roundNumber = v;
    }
    ...
    public void setRoundNumberStr(String v) {
        this.roundNumberStr = v;
    }

    public Long getTkStrikeSystemTimestamp() {
        return tkStrikeSystemTimestamp;
    }

    public void setTkStrikeSystemTimestamp(Long v) {
        this.tkStrikeSystemTimestamp = v;
    }

    public String getTkStrikeSystemTimestampStr() {
        return tkStrikeSystemTimestampStr;
    }

    public void setTkStrikeSystemTimestampStr(String v) {
        this.tkStrikeSystemTimestampStr = v;
    }
    ...
    public void setRoundTimestamp(Long v) {
        this.roundTimestamp = v;
    }

    public String getRoundTimestampStr() {
        return roundTimestampStr;
    }

    public void setRoundTimestampStr(String v) {
        this.roundTimestampStr = v;
    }
    ...
    public boolean isEventAddPoints() {
        return eventAddPoints;
    }

    public void setEventAddPoints(boolean v) {
        this.eventAddPoints = v;
    }

    public boolean isEventRemovePoints() {
        return eventRemovePoints;
    }

    public void setEventRemovePoints(boolean v) {
        this.eventRemovePoints = v;
    }
    ...
    public void setMatchWinner(String v) {
        this.matchWinner = v;
    }
    ...
    public Integer getBlueBodyLevel() {
        return blueBodyLevel;
    }

    public void setBlueBodyLevel(Integer v) {
        this.blueBodyLevel = v;
    }

    public Integer getBlueHeadLevel() {
        return blueHeadLevel;
    }

    public void setBlueHeadLevel(Integer v) {
        this.blueHeadLevel = v;
    }
    ...
    public void setRedBodyLevel(Integer v) {
        this.redBodyLevel = v;
    }
    ...
    public void setRedHeadLevel(Integer v) {
        this.redHeadLevel = v;
    }

    public Integer getCalledByJudgeNumber() {
        return calledByJudgeNumber;
    }

    public void setCalledByJudgeNumber(Integer v) {
        this.calledByJudgeNumber = v;
    }
    ...
    public void setPARASpinning(Boolean v) {
        this.isPARASpinning = v;
    }
}
